...
namespace MinhaListadeTarefas.Controllers
{
    public class ResponsavelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name")] Responsavel responsavel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name")] Responsavel responsavel)
        {
