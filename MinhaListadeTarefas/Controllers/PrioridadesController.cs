...
namespace MinhaListadeTarefas.Controllers
{
    public class PrioridadesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name")] Prioridade prioridade)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name")] Prioridade prioridade)
        {
            if (id != prioridade.Id)
            {
                return NotFound();
